...
if(cur&&curR){
  ...
  document.querySelectorAll('a,button,.share-btn,.tag,.toc-list li a,.related-article,.an-card').forEach(el=>{
...
function copyLink(e){
  ...
  navigator.clipboard?.writeText(window.location.href).then(()=>{
    ...
    btn.innerHTML='<iconify-icon icon="mdi:check"></iconify-icon>Lien copié !';
    btn.style.borderColor='var(--lime)';btn.style.color='var(--green-dark)';
